      ...
      <div className="pt-16 mt-5 w-2/5 text-center relative">
        ...
        <div className="ml-10 flex flex-col mt-5 space-y-12 relative">
          <div className="flex space-x-10 relative">
            ...
            <div className="active:bg-red hover:bg-green-700  rounded-md tracking-widest font-bold bg-dgreen shadow-lg flex justify-center align-center py-2.5 px-7 h-10 text-sm text-white absolute left-32">
              ON
            </div>
          ...
          <div className="flex space-x-10 relative">
            ...
            <div className="font-bold bg-dgreen shadow-sm flex justify-center align-center py-2.5 text-sm px-7 h-10 text-white absolute left-32">
              ON
            </div>
            <div className="bg-gray-700 text-white font-bold flex shadow-sm justify-center align-center py-2.5 text-sm px-7 h-10 absolute right-24">
              OFF
            </div>
          </div>
          <div className="flex space-x-10 relative">
            ...
            <div className="font-bold bg-gray-700 text-white flex shadow-sm justify-center align-center py-2.5 text-sm px-7 h-10 absolute right-24">
              OFF
            </div>
          </div>
          <div className="flex space-x-10 relative">
